    ...
    extractColors(node) {
        ...
        if ('fills' in node && Array.isArray(node.fills)) {
            for (const fill of node.fills) {
                if (fill.type === 'SOLID') {
                    const color = this.rgbaToColor(fill.color, (_a = fill.opacity) !== null && _a !== void 0 ? _a : 1);
                    colors.push({
                        type: 'fill',
                        color: {
                            r: fill.color.r,
                            g: fill.color.g,
                            b: fill.color.b,
                            a: (_b = fill.opacity) !== null && _b !== void 0 ? _b : 1
                        },
                        hex: color.hex,
                        rgba: color.rgba,
                        opacity: (_c = fill.opacity) !== null && _c !== void 0 ? _c : 1
                    });
                }
            }
        }
        ...
        if ('strokes' in node && Array.isArray(node.strokes)) {
            for (const stroke of node.strokes) {
                if (stroke.type === 'SOLID') {
                    const color = this.rgbaToColor(stroke.color, (_d = stroke.opacity) !== null && _d !== void 0 ? _d : 1);
                    colors.push({
                        type: 'stroke',
                        color: {
                            r: stroke.color.r,
                            g: stroke.color.g,
                            b: stroke.color.b,
                            a: (_e = stroke.opacity) !== null && _e !== void 0 ? _e : 1
                        },
                        hex: color.hex,
                        rgba: color.rgba,
                        opacity: (_f = stroke.opacity) !== null && _f !== void 0 ? _f : 1
                    });
                }
            }
        }
